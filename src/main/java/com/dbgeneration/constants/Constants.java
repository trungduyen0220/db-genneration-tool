...
public class Constants {
	...
	public static final String CHECK_CONSTRAINT = "Check constraint";
	
	public static final String STRING_ALPHA_KANJI_JAPANESE = "相勝談勝受都付者電強話読産語持聞力工世心理切不死高務組家調作野体協現連題原気意最戦制取約米勝約";
